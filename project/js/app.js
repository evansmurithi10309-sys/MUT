...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderListings(housesToRender) {
    ...
    if (!housesToRender || housesToRender.length === 0) {
      ...
      if (listingsCount) listingsCount.textContent = 'No houses found match your criteria.';
      return;
    }
    ...
    housesToRender.forEach(house => {
      ...
      card.innerHTML = `
        ...
        <div class="house-card-body">
          <h3 class="house-card-title">${escapeHtml(house.title)}</h3>
  ...
  window.viewHouseDetails = function(houseId) {
    ...
    if (isPaid) {
      ...
      if (feeBadge) {
        ...
        feeBadge.style.background = 'rgba(16, 185, 129, 0.15)';
        feeBadge.style.color = 'var(--success)';
      ...
      document.getElementById('modal-landlord-phone').innerHTML = `
        <a href="tel:${house.landlordPhone}" style="color: var(--accent-light-blue); text-decoration: none; font-weight: 700;">📞 ${house.landlordPhone}</a>
        <a href="https://wa.me/254${formatPhoneForWhatsApp(house.landlordPhone)}" target="_blank" style="margin-left: 0.75rem; color: #25d366; font-size: 0.9rem; font-weight: 600; text-decoration: none;">💬 WhatsApp Landlord</a>
      `;
      ...
      if (feeBadge) {
        ...
        feeBadge.style.background = 'rgba(56, 189, 248, 0.15)';
        feeBadge.style.color = 'var(--accent-light-blue)';
        feeBadge.style.borderColor = 'rgba(56, 189, 248, 0.3)';
      }
    }
